...
/**
 * This wraps react-hook-form's `useForm` hook with two additional features:
 * - Pass in a Zod schema to validate the form data
 * - Catch any errors thrown by the onValid callback and set them as form errors
 *
 * @param props
 */
const useForm = <TFieldValues extends FieldValues>({
  ...
  const { handleSubmit, ...form } = useReactHookForm<TFieldValues>({
